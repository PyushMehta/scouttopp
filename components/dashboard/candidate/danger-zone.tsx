      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-muted mt-0.5 mb-4 max-w-md">
            Permanently delete your account, profile, and portfolio. This cannot be undone.
          </p>
      ...
      >
        <div className="space-y-4">
          <p className="text-sm text-muted">
            This will permanently delete your account, profile, and all portfolio items. This action cannot be undone.
          </p>
          <Input
